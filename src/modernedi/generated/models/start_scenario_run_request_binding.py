...
class StartScenarioRunRequestBinding(BaseModel):
    """
    StartScenarioRunRequestBinding
    """ # noqa: E501
    ...
    __properties: ClassVar[List[str]] = ["id", "revision", "contentSha256"]
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of StartScenarioRunRequestBinding from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of StartScenarioRunRequestBinding from a dict"""
        if obj is None:
            return None
