...
class TransactionMappedOutput(BaseModel):
    """
    ...
    payload: Optional[StrictStr] = Field(description="Mapped output body. Parse according to `contentType`.")
    additional_properties: Dict[str, Any] = {}
    __properties: ClassVar[List[str]] = ["id", "sequenceNumber", "purpose", "contentType", "createdAt", "businessKey", "mapping", "extraFields", "payload"]
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of TransactionMappedOutput from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of TransactionMappedOutput from a dict"""
        if obj is None:
            return None
