...
class ConfigurationManifestResource(BaseModel):
    """
    ConfigurationManifestResource
    """ # noqa: E501
    kind: ConfigurationResourceKind
    key: UUID = Field(description="Stable portable resource key used by other exported resources.")
    path: StrictStr = Field(description="Path of the resource document in this bundle.")
    ...
    __properties: ClassVar[List[str]] = ["kind", "key", "path", "contentSha256"]
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of ConfigurationManifestResource from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of ConfigurationManifestResource from a dict"""
        if obj is None:
            return None
