...
class RelatedTransactionsResponse(BaseModel):
    ...
    related_transactions: List[TransactionSummary] = Field(description="Compact summaries of linked outbound reply transactions; empty when no replies are recorded. Fetch a selected reply's detail for its acknowledgment and document index.", alias="relatedTransactions")
    additional_properties: Dict[str, Any] = {}
    __properties: ClassVar[List[str]] = ["success", "environment", "transaction", "relatedTransactions"]
