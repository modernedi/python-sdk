...
class FunctionalAcknowledgmentSummary(BaseModel):
    """
    ...
    acknowledgment_code: Optional[StrictStr] = Field(description="Original AK901 functional-group acknowledgment code, when available.", alias="acknowledgmentCode", json_schema_extra={"examples": ["A"]})
    summary: StrictStr = Field(description="Human-readable whole-997 aggregate result.", json_schema_extra={"examples": ["Functional group accepted; 1 of 1 received transaction set was accepted."]})
    additional_properties: Dict[str, Any] = {}
    __properties: ClassVar[List[str]] = ["status", "acknowledgmentCode", "summary"]
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of FunctionalAcknowledgmentSummary from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of FunctionalAcknowledgmentSummary from a dict"""
        if obj is None:
            return None
