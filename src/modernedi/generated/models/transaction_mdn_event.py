...
from modernedi.generated.models.transaction_mdn_event_details import TransactionMdnEventDetails
from typing import Optional, Set
from typing_extensions import Self
from pydantic_core import to_jsonable_python

class TransactionMdnEvent(BaseModel):
    """
    ...
    type: StrictStr = Field(description="Identifies the waiting, overdue, sent, or received AS2 receipt transition.")
    ...
    def type_validate_enum(cls, value):
        """Validates the enum"""
        if value not in set(['mdn.pending', 'mdn.overdue', 'mdn.sent', 'mdn.received']):
            raise ValueError("must be one of enum values ('mdn.pending', 'mdn.overdue', 'mdn.sent', 'mdn.received')")
        return value
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of TransactionMdnEvent from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of TransactionMdnEvent from a dict"""
        if obj is None:
            return None
        ...
        _obj = cls.model_validate({key: value for key, value in {
            ...
            "details": TransactionMdnEventDetails.from_dict(obj["details"]) if obj.get("details") is not None else None
        }.items() if key in obj})
