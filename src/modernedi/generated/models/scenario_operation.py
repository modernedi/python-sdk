...
class ScenarioOperation(BaseModel):
    ...
    action: Annotated[str, Field(strict=True)] = Field(description="Opaque operation telemetry. Clients transition from the returned run, ETag, and guidance rather than parsing this value.")
    ...
    __properties: ClassVar[List[str]] = ["id", "action", "disposition", "fromRevision", "toRevision"]
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of ScenarioOperation from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of ScenarioOperation from a dict"""
        if obj is None:
            return None
