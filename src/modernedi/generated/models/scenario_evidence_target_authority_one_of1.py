...
class ScenarioEvidenceTargetAuthorityOneOf1(BaseModel):
    """
    ScenarioEvidenceTargetAuthorityOneOf1
    """ # noqa: E501
    ...
    kind: StrictStr
    adapter_id: Annotated[str, Field(min_length=1, strict=True)] = Field(alias="adapterId")
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of ScenarioEvidenceTargetAuthorityOneOf1 from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of ScenarioEvidenceTargetAuthorityOneOf1 from a dict"""
        if obj is None:
            return None
