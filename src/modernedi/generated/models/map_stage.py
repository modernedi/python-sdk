...
class MapStage(BaseModel):
    ...
    kind: StrictStr = Field(description="Confirm the exact runtime mapping selected by an applied binding. A step may declare this stage once, immediately next to exchange. Apply requires it before exchange for outgoing documents and after exchange for incoming documents.")
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of MapStage from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of MapStage from a dict"""
        if obj is None:
            return None
