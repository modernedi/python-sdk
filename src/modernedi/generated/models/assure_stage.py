...
class AssureStage(BaseModel):
    ...
    kind: StrictStr = Field(description="Evaluate the step's declared operational evidence requirements. A step may declare this stage at most once.")
    ...
    def kind_validate_enum(cls, value):
        """Validates the enum"""
        if value not in set(['assure']):
            raise ValueError("must be one of enum values ('assure')")
        return value
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of AssureStage from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of AssureStage from a dict"""
        if obj is None:
            return None
