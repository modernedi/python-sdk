...
class TransactionEventsResponse(BaseModel):
    ...
    events: List[TransactionEvent] = Field(description="Derived transaction, mapping, delivery, MDN, and acknowledgment events in chronological order.")
    additional_properties: Dict[str, Any] = {}
    __properties: ClassVar[List[str]] = ["success", "environment", "events"]
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of TransactionEventsResponse from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of TransactionEventsResponse from a dict"""
        if obj is None:
            return None
