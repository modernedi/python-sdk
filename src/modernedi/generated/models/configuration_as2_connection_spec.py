...
from modernedi.generated.models.configuration_as2_environments import ConfigurationAs2Environments
from typing import Optional, Set
from typing_extensions import Self
from pydantic_core import to_jsonable_python

class ConfigurationAs2ConnectionSpec(BaseModel):
    """
    ...
    cms_algorithm_protection: StrictBool = Field(description="Effective RFC 6211 `cmsAlgorithmProtect` compatibility setting.", alias="cmsAlgorithmProtection")
    ...
    __properties: ClassVar[List[str]] = ["environments", "outbound", "functionalAcknowledgment", "mdn", "cmsAlgorithmProtection", "digestCanonicalizationPolicy"]
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of ConfigurationAs2ConnectionSpec from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of ConfigurationAs2ConnectionSpec from a dict"""
        if obj is None:
            return None
        ...
        _obj = cls.model_validate({key: value for key, value in {
            "environments": ConfigurationAs2Environments.from_dict(obj["environments"]) if obj.get("environments") is not None else None,
