...
class ExchangeStage(BaseModel):
    ...
    kind: StrictStr = Field(description="Observe or perform the business-document exchange. Exactly one is required per step.")
    ...
    def kind_validate_enum(cls, value):
        """Validates the enum"""
        if value not in set(['exchange']):
            raise ValueError("must be one of enum values ('exchange')")
        return value
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of ExchangeStage from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of ExchangeStage from a dict"""
        if obj is None:
            return None
