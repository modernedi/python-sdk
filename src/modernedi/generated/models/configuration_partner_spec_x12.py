...
CONFIGURATIONPARTNERSPECX12_ANY_OF_SCHEMAS = ["PartnerDraftX12Identities", "PartnerX12Identities"]

class ConfigurationPartnerSpecX12(BaseModel):
    """
    ...
    def actual_instance_must_validate_anyof(cls, v):
        instance = ConfigurationPartnerSpecX12.model_construct()
        error_messages = []
        ...
        if error_messages:
            # no match
            raise ValueError("No match found when setting the actual_instance in ConfigurationPartnerSpecX12 with anyOf schemas: PartnerDraftX12Identities, PartnerX12Identities. Details: " + ", ".join(error_messages))
        else:
            return v
    ...
    def from_json(cls, json_str: str) -> Self:
        ...
        if error_messages:
            # no match
            raise ValueError("No match found when deserializing the JSON string into ConfigurationPartnerSpecX12 with anyOf schemas: PartnerDraftX12Identities, PartnerX12Identities. Details: " + ", ".join(error_messages))
        else:
            return instance
