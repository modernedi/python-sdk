...
class ScenarioRunObservationRequest(BaseModel):
    """
    ...
    __properties: ClassVar[List[str]] = ["stepId", "occurrence", "messageId", "transactionKey"]
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of ScenarioRunObservationRequest from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of ScenarioRunObservationRequest from a dict"""
        if obj is None:
            return None
