...
from modernedi.generated.models.mapping_configuration_revision_transform_summary import MappingConfigurationRevisionTransformSummary
from modernedi.generated.models.syntax_tree_catalog_binding import SyntaxTreeCatalogBinding
from typing import Optional, Set
from typing_extensions import Self
from pydantic_core import to_jsonable_python

class MappingConfigurationRevisionSummary(BaseModel):
    """
    MappingConfigurationRevisionSummary
    """ # noqa: E501
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of MappingConfigurationRevisionSummary from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of MappingConfigurationRevisionSummary from a dict"""
        if obj is None:
            return None
        ...
        _obj = cls.model_validate({key: value for key, value in {
            ...
            "transform": MappingConfigurationRevisionTransformSummary.from_dict(obj["transform"]) if obj.get("transform") is not None else None
        }.items() if key in obj})
