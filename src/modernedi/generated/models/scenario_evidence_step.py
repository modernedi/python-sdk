...
from modernedi.generated.models.scenario_evidence_occurrence import ScenarioEvidenceOccurrence
from typing import Optional, Set
from typing_extensions import Self
from pydantic_core import to_jsonable_python

class ScenarioEvidenceStep(BaseModel):
    """
    ...
    occurrences: List[ScenarioEvidenceOccurrence]
    __properties: ClassVar[List[str]] = ["stepId", "fromActor", "toActor", "transactionSet", "direction", "targetKind", "occurrences"]
    ...
    def target_kind_validate_enum(cls, value):
        """Validates the enum"""
        if value not in set(['runtime_mapping', 'adapter', 'observation_only']):
            raise ValueError("must be one of enum values ('runtime_mapping', 'adapter', 'observation_only')")
        return value
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of ScenarioEvidenceStep from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of ScenarioEvidenceStep from a dict"""
        if obj is None:
            return None
        ...
        _obj = cls.model_validate({key: value for key, value in {
            ...
            "occurrences": [ScenarioEvidenceOccurrence.from_dict(_item) for _item in obj["occurrences"]] if obj.get("occurrences") is not None else None
        }.items() if key in obj})
        return _obj
