...
from modernedi.generated.models.scenario_run_timeline_operation_error import ScenarioRunTimelineOperationError
from typing import Optional, Set
from typing_extensions import Self
from pydantic_core import to_jsonable_python

class ScenarioRunTimelineOperation(BaseModel):
    """
    ...
    status: StrictStr
    expected_run_revision: Annotated[int, Field(strict=True, ge=0)] = Field(alias="expectedRunRevision")
    ...
    error: Optional[ScenarioRunTimelineOperationError]
    __properties: ClassVar[List[str]] = ["operationId", "action", "status", "expectedRunRevision", "actor", "attempts", "requestedAt", "startedAt", "completedAt", "lastUpdatedAt", "error"]
    ...
    def status_validate_enum(cls, value):
        """Validates the enum"""
        if value not in set(['processing', 'succeeded', 'failed']):
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of ScenarioRunTimelineOperation from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of ScenarioRunTimelineOperation from a dict"""
        if obj is None:
            return None
        ...
        _obj = cls.model_validate({key: value for key, value in {
            ...
            "expectedRunRevision": obj.get("expectedRunRevision"),
            ...
            "error": ScenarioRunTimelineOperationError.from_dict(obj["error"]) if obj.get("error") is not None else None
        }.items() if key in obj})
        return _obj
