...
class ConfigurationScenarioDefinitionCorrelation(BaseModel):
    """
    ...
    operator: StrictStr
    left: Optional[ConfigurationScenarioDefinitionFactOperand] = None
    right: Optional[ConfigurationScenarioDefinitionFactOperand] = None
    ...
    def operator_validate_enum(cls, value):
        """Validates the enum"""
        if value not in set(['equal', 'same_set', 'reply_link']):
            raise ValueError("must be one of enum values ('equal', 'same_set', 'reply_link')")
        return value
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of ConfigurationScenarioDefinitionCorrelation from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of ConfigurationScenarioDefinitionCorrelation from a dict"""
        if obj is None:
            return None
        ...
        _obj = cls.model_validate({key: value for key, value in {
            ...
            "left": ConfigurationScenarioDefinitionFactOperand.from_dict(obj["left"]) if obj.get("left") is not None else None,
            "right": ConfigurationScenarioDefinitionFactOperand.from_dict(obj["right"]) if obj.get("right") is not None else None
        }.items() if key in obj})
        return _obj
