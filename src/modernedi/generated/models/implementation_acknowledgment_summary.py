...
class ImplementationAcknowledgmentSummary(BaseModel):
    """
    ...
    summary: StrictStr = Field(description="Human-readable aggregate 999 result.", json_schema_extra={"examples": ["Implementation acknowledgment accepted; 1 of 1 received transaction set was accepted."]})
    groups: List[ImplementationAcknowledgmentGroupOutcome] = Field(description="Compact response retains each AK1/AK9 group so transactions can be evaluated without collapsing sibling groups.")
    additional_properties: Dict[str, Any] = {}
    __properties: ClassVar[List[str]] = ["status", "acknowledgmentCode", "summary", "groups"]
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of ImplementationAcknowledgmentSummary from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of ImplementationAcknowledgmentSummary from a dict"""
        if obj is None:
            return None
