...
class ScenarioRunSummaryGuidanceOneOf2(BaseModel):
    """
    ScenarioRunSummaryGuidanceOneOf2
    """ # noqa: E501
    ...
    def next_action_validate_enum(cls, value):
        """Validates the enum"""
        if value not in set(['advance_adapter']):
            raise ValueError("must be one of enum values ('advance_adapter')")
        return value
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of ScenarioRunSummaryGuidanceOneOf2 from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of ScenarioRunSummaryGuidanceOneOf2 from a dict"""
        if obj is None:
            return None
