...
from modernedi.generated.models.transaction_mapped_output_delivery import TransactionMappedOutputDelivery
...
class StoredTransactionMappedOutput(BaseModel):
    """
    ...
    __properties: ClassVar[List[str]] = ["id", "sequenceNumber", "purpose", "contentType", "createdAt", "businessKey", "mapping", "extraFields", "delivery"]
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of StoredTransactionMappedOutput from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of StoredTransactionMappedOutput from a dict"""
        if obj is None:
            return None
        ...
        _obj = cls.model_validate({key: value for key, value in {
            ...
            "delivery": TransactionMappedOutputDelivery.from_dict(obj["delivery"]) if obj.get("delivery") is not None else None
        }.items() if key in obj})
