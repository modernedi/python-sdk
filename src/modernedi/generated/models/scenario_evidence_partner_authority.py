...
class ScenarioEvidencePartnerAuthority(BaseModel):
    """
    ...
    configuration_sha256: Annotated[str, Field(strict=True)] = Field(alias="configurationSha256")
    __properties: ClassVar[List[str]] = ["actorId", "id", "configurationSha256"]
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of ScenarioEvidencePartnerAuthority from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of ScenarioEvidencePartnerAuthority from a dict"""
        if obj is None:
            return None
