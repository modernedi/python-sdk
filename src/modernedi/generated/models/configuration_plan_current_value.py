...
class ConfigurationPlanCurrentValue(BaseModel):
    """
    Observed current identity for an UPDATE or DELETE operation.
    """ # noqa: E501
    resource_id: Annotated[int, Field(strict=True, ge=1)] = Field(description="Current tenant-scoped API resource id. Portable references continue to use `key`.", alias="resourceId")
    ...
    api_etag: Annotated[str, Field(strict=True)] = Field(description="Current public configuration ETag observed in the same snapshot.", alias="apiEtag")
    __properties: ClassVar[List[str]] = ["resourceId", "contentSha256", "apiEtag"]
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of ConfigurationPlanCurrentValue from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of ConfigurationPlanCurrentValue from a dict"""
        if obj is None:
            return None
