...
from modernedi.generated.models.configuration_mapping_spec import ConfigurationMappingSpec
from modernedi.generated.models.configuration_resource_metadata import ConfigurationResourceMetadata
from typing import Optional, Set
from typing_extensions import Self
from pydantic_core import to_jsonable_python

class ConfigurationMappingResourceDocument(BaseModel):
    """
    ...
    def kind_validate_enum(cls, value):
        """Validates the enum"""
        if value not in set(['Mapping']):
            raise ValueError("must be one of enum values ('Mapping')")
        return value
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of ConfigurationMappingResourceDocument from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of ConfigurationMappingResourceDocument from a dict"""
        if obj is None:
            return None
        ...
        _obj = cls.model_validate({key: value for key, value in {
            ...
            "spec": ConfigurationMappingSpec.from_dict(obj["spec"]) if obj.get("spec") is not None else None
        }.items() if key in obj})
        return _obj
