...
class X12ValidationResponse(BaseModel):
    """
    Successful X12 parser and standards-validation result.
    """ # noqa: E501
    success: StrictBool = Field(description="Always `true`; invalid X12 is reported in `validation`, while request-level failures use an error response.")
    validation: X12ValidationResult
    additional_properties: Dict[str, Any] = {}
    __properties: ClassVar[List[str]] = ["success", "validation"]
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of X12ValidationResponse from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of X12ValidationResponse from a dict"""
        if obj is None:
            return None
