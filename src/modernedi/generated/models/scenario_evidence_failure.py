...
from modernedi.generated.models.scenario_evidence_failure_error import ScenarioEvidenceFailureError
from modernedi.generated.models.scenario_run_actor import ScenarioRunActor
from typing import Optional, Set
from typing_extensions import Self
from pydantic_core import to_jsonable_python

class ScenarioEvidenceFailure(BaseModel):
    """
    ...
    __properties: ClassVar[List[str]] = ["operationId", "action", "expectedRunRevision", "actor", "requestedAt", "completedAt", "error"]
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of ScenarioEvidenceFailure from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of ScenarioEvidenceFailure from a dict"""
        if obj is None:
            return None
        ...
        _obj = cls.model_validate({key: value for key, value in {
            ...
            "error": ScenarioEvidenceFailureError.from_dict(obj["error"]) if obj.get("error") is not None else None
        }.items() if key in obj})
        return _obj
