...
class ConfigurationManifestFile(BaseModel):
    """
    ConfigurationManifestFile
    """ # noqa: E501
    path: StrictStr = Field(description="Desired resource or source path in this bundle.")
    ...
    __properties: ClassVar[List[str]] = ["path", "contentSha256"]
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of ConfigurationManifestFile from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of ConfigurationManifestFile from a dict"""
        if obj is None:
            return None
