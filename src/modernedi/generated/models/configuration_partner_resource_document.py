...
from modernedi.generated.models.configuration_partner_spec import ConfigurationPartnerSpec
from modernedi.generated.models.configuration_resource_metadata import ConfigurationResourceMetadata
from typing import Optional, Set
from typing_extensions import Self
from pydantic_core import to_jsonable_python

class ConfigurationPartnerResourceDocument(BaseModel):
    """
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of ConfigurationPartnerResourceDocument from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of ConfigurationPartnerResourceDocument from a dict"""
        if obj is None:
            return None
        ...
        _obj = cls.model_validate({key: value for key, value in {
            ...
            "spec": ConfigurationPartnerSpec.from_dict(obj["spec"]) if obj.get("spec") is not None else None
        }.items() if key in obj})
        return _obj
