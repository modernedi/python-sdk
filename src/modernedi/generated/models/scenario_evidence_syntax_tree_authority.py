...
class ScenarioEvidenceSyntaxTreeAuthority(BaseModel):
    """
    ...
    catalog_revision: Annotated[str, Field(strict=True)] = Field(alias="catalogRevision")
    catalog_manifest_sha256: Annotated[str, Field(strict=True)] = Field(alias="catalogManifestSha256")
    syntax_tree_sha256: Annotated[str, Field(strict=True)] = Field(alias="syntaxTreeSha256")
    __properties: ClassVar[List[str]] = ["stepId", "x12Version", "transactionSet", "catalogRevision", "catalogManifestSha256", "syntaxTreeSha256"]
    ...
    @field_validator('catalog_manifest_sha256', mode="before")
    def catalog_manifest_sha256_validate_regular_expression(cls, value):
        """Validates the regular expression"""
        if isinstance(value, str) and not re.match(r"^[0-9a-f]{64}$", value):
            raise ValueError(r"must validate the regular expression /^[0-9a-f]{64}$/")
        return value
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of ScenarioEvidenceSyntaxTreeAuthority from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of ScenarioEvidenceSyntaxTreeAuthority from a dict"""
        if obj is None:
            return None
        ...
        _obj = cls.model_validate({key: value for key, value in {
            ...
            "catalogManifestSha256": obj.get("catalogManifestSha256"),
