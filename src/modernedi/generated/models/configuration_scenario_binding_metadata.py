...
class ConfigurationScenarioBindingMetadata(BaseModel):
    """
    ...
    name: Annotated[str, Field(min_length=1, strict=True, max_length=160)] = Field(description="Human-readable binding name. The server trims leading and trailing whitespace when canonicalizing.")
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of ConfigurationScenarioBindingMetadata from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of ConfigurationScenarioBindingMetadata from a dict"""
        if obj is None:
            return None
