...
class TransactionMappingStatusSummary(BaseModel):
    """
    TransactionMappingStatusSummary
    """ # noqa: E501
    ...
    __properties: ClassVar[List[str]] = ["status", "latestAttemptAt", "failureCount"]
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of TransactionMappingStatusSummary from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of TransactionMappingStatusSummary from a dict"""
        if obj is None:
            return None
