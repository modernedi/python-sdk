...
class ConfigurationPlanScenarioResource(BaseModel):
    """
    ...
    __properties: ClassVar[List[str]] = ["kind", "key", "action"]
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of ConfigurationPlanScenarioResource from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of ConfigurationPlanScenarioResource from a dict"""
        if obj is None:
            return None
