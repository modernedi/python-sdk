...
class ImplementationAcknowledgmentGroupOutcome(BaseModel):
    """
    ImplementationAcknowledgmentGroupOutcome
    """ # noqa: E501
    ...
    functional_group_version: Optional[StrictStr] = Field(description="AK103 version or implementation-convention reference echoed from the acknowledged group.", alias="functionalGroupVersion", json_schema_extra={"examples": ["5010"]})
    status: ImplementationAcknowledgmentStatus
    acknowledgment_code: Optional[StrictStr] = Field(description="Original AK901 acknowledgment code for this implementation group, when available.", alias="acknowledgmentCode", json_schema_extra={"examples": ["A"]})
    ...
    accepted_transaction_sets: Optional[Annotated[int, Field(strict=True, ge=0)]] = Field(description="AK904, the number of received transaction sets accepted in this functional group.", alias="acceptedTransactionSets")
    error_codes: List[StrictStr] = Field(description="Non-empty AK905 and later implementation-group syntax error codes.", alias="errorCodes")
    transaction_sets: List[ImplementationAcknowledgmentTransactionSetOutcome] = Field(description="AK2/IK5 results belonging to this AK1/AK9 group.", alias="transactionSets")
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of ImplementationAcknowledgmentGroupOutcome from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of ImplementationAcknowledgmentGroupOutcome from a dict"""
        if obj is None:
            return None
