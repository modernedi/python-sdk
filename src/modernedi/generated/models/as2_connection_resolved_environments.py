...
class As2ConnectionResolvedEnvironments(BaseModel):
    """
    ...
    test: Optional[As2PartnerEnvironmentResolved] = Field(description="Fully resolved test environment, or `null` when no test profile is configured.")
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of As2ConnectionResolvedEnvironments from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of As2ConnectionResolvedEnvironments from a dict"""
        if obj is None:
            return None
        ...
        _obj = cls.model_validate({key: value for key, value in {
            "production": As2PartnerEnvironmentResolved.from_dict(obj["production"]) if obj.get("production") is not None else None,
            "test": As2PartnerEnvironmentResolved.from_dict(obj["test"]) if obj.get("test") is not None else None
        }.items() if key in obj})
        return _obj
