...
class TransactionFunctionalAcknowledgmentMdnEvent(BaseModel):
    """
    ...
    type: StrictStr = Field(description="Indicates whether ModernEDI sent or received the MDN for the X12 997.")
    ...
    def type_validate_enum(cls, value):
        """Validates the enum"""
        if value not in set(['functional_ack.mdn_sent', 'functional_ack.mdn_received']):
            raise ValueError("must be one of enum values ('functional_ack.mdn_sent', 'functional_ack.mdn_received')")
        return value
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of TransactionFunctionalAcknowledgmentMdnEvent from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of TransactionFunctionalAcknowledgmentMdnEvent from a dict"""
        if obj is None:
            return None
        ...
        _obj = cls.model_validate({key: value for key, value in {
            ...
            "details": TransactionFunctionalAcknowledgmentMdnMetadata.from_dict(obj["details"]) if obj.get("details") is not None else None
        }.items() if key in obj})
