...
class MappingConfigurationSnapshot(BaseModel):
    """
    ...
    __properties: ClassVar[List[str]] = ["mappingId", "partnerId", "direction", "x12Version", "functionalIdentifierCode", "transactionSetIdentifierCode", "syntaxTreeCatalog", "transform", "output", "businessKey", "deliveredMetadata", "runtime"]
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of MappingConfigurationSnapshot from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of MappingConfigurationSnapshot from a dict"""
        if obj is None:
            return None
