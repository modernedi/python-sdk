...
from modernedi.generated.models.transaction_implementation_acknowledgment_event_details import TransactionImplementationAcknowledgmentEventDetails
from typing import Optional, Set
from typing_extensions import Self
from pydantic_core import to_jsonable_python

class TransactionImplementationAcknowledgmentEvent(BaseModel):
    """
    ...
    type: StrictStr = Field(description="Indicates whether ModernEDI sent or received the X12 999.")
    ...
    def type_validate_enum(cls, value):
        """Validates the enum"""
        if value not in set(['implementation_ack.sent', 'implementation_ack.received']):
            raise ValueError("must be one of enum values ('implementation_ack.sent', 'implementation_ack.received')")
        return value
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of TransactionImplementationAcknowledgmentEvent from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of TransactionImplementationAcknowledgmentEvent from a dict"""
        if obj is None:
            return None
        ...
        _obj = cls.model_validate({key: value for key, value in {
            ...
            "details": TransactionImplementationAcknowledgmentEventDetails.from_dict(obj["details"]) if obj.get("details") is not None else None
        }.items() if key in obj})
