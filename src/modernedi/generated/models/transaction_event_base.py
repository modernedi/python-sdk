...
class TransactionEventBase(BaseModel):
    ...
    type: StrictStr = Field(description="Machine-readable discriminator for the concrete `details` schema.")
    ...
    details: Dict[str, Any] = Field(description="Event-specific structured context selected by `type`.")
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of TransactionEventBase from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of TransactionEventBase from a dict"""
        if obj is None:
            return None
